...
/**
 * Класс описывает клетки шахматной доски.
 * Содержит систему координат x и y в виде списка элементов перечисления.
 */
public enum Cell {
    ...
    /**
     * Метод ищет и возвращает координаты клетки, куда пошла фигура.
     */	
