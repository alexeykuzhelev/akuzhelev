...
public class ProfilesTest {
     ...
     */
    @Test
    public void whenHaveListOfProfilesThenGetSortedByCityDistinctListOfAdresses() {
        List<Address> expected = Arrays.asList(address3, address2);
        List<Address> result = profiles.getSortedByCityDistinctListOfAddresses(profilesClients);
        assertThat(expected, is(result));
    }
}
